...
using Best.MQTT.Packets.Readers;
...
namespace Best.MQTT
{
    public sealed partial class MQTTClient
    {
        ...
        private void HandlePublishPacket(Packet packet)
        {
            ...
            var applicationMessages = PacketReaderImplementations.CreateApplicationMessages(this, packet);
        ...
        private void HandleConnectAckPacket(Packet packet)
        {
            ...
            if (msg.ReasonCode == ConnectAckReasonCodes.Success)
            {
                ...
                {
                    this.Session.PublishReceivedPacketIDs.Clear();
                    this.Session.PublishReleasedPacketIDs.Clear();

                    this.Session.UnacknowledgedPackets.Clear();
                }
                else
                {
                ...
                this.Session.ClientTopicAliasMapping.Clear();

                this.lastPacketSentAt = DateTime.UtcNow;
