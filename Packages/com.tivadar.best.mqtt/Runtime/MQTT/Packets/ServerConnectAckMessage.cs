...
namespace Best.MQTT.Packets
{
    ...
    public readonly struct ServerConnectAckMessage
    {
        ...
        public readonly Best.HTTP.Shared.PlatformSupport.Memory.BufferSegment AuthenticationData;
        ...
        internal ServerConnectAckMessage(Packet packet)
        {
            ...
            this.AuthenticationData = properties.TryFindData(PacketProperties.AuthenticationData, DataTypes.Binary, out data) ? data.Binary : Best.HTTP.Shared.PlatformSupport.Memory.BufferSegment.Empty;
        }
    }
}
