...
namespace Best.MQTT.Packets.Builders
{
    ...
    public struct SubscribePacketBuilder
    {
        ...
        public SubscribePacketBuilder WithRetainHandlingOptions(RetainHandlingOptions options)
        {
    ...
    public struct BulkSubscribePacketBuilder
    {
        ...
        public BulkSubscribePacketBuilder WithTopic(SubscribeTopicBuilder topicBuilder)
        {
            ...
            else if (this._topicBuilder.IsSet)
            {
                ...
                this._topicBuilder.WithMaximumQoS(this._client.NegotiatedOptions.ServerOptions.MaximumQoS);
            }
        ...
        internal (Packet, Subscription) Build(MQTTClient parentClient)
        {
            ...
            if (parentClient.NegotiatedOptions.ServerOptions.SubscriptionIdentifiersAvailable)
    ...
    public struct SubscribeTopicBuilder
    {
        ...
        public SubscribeTopicBuilder WithRetainHandlingOptions(RetainHandlingOptions options)
        {
            switch (options)
            {
                case RetainHandlingOptions.SendWhenSubscribeIfSubscriptionDoesntExist: this._flags[4] = true; break;
                case RetainHandlingOptions.DoNotSendRetainedMessages: this._flags[5] = true; break;
            }
