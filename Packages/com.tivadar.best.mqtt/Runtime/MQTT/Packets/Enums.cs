...
namespace Best.MQTT.Packets
{
    ...
    /// </summary>
    public enum RetainHandlingOptions : byte
    {
        /// <summary>
    ...
    public enum ConnectAckReasonCodes : byte
    {
        ...
        // v3.1.1 errors
        v311_UnacceptableProtocolVersion = 0x01,
        v311_IdentifierRejected = 0x02,
        v311_ServerUnavailable = 0x03,
        v311_BadUserNameOrPassword = 0x04,
        v311_NotAuthorized = 0x05,
